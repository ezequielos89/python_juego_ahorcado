...
def juego_ahorcado():
    ...
    while not juego_terminado:
        ...
        if "_" not in progreso_actual:
            ...
            print(f"¡Felicitaciones hasta ganado! La palabra completa es: '{palabra_secreta}'")
        
    if intentos == 0:
        print(f"Lo sentimos mucho se te han acabado los intetos, la palabra secreta era '{palabra_secreta}'")
